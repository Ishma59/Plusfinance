...
urlpatterns = [
    ...
    url(r'^profitandlosspdfdownload/(?P<date>)/$', profitandloss_pdf_download, name="profitandlosspdfdownload"),
    url(r'^profitandloss/$', ProfitAndLossReportView.as_view(), name="profitandloss"),
    ...
    url(r'^generalledgerpdfdownload/$', general_ledger_pdf_download, name="generalledgerpdfdownload"),
    url(r'^daybookpdfdownload/(?P<date>)/$', daybook_pdf_download, name="daybookpdfdownload"),
