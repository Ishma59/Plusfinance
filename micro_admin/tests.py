...
class Modelform_test(TestCase):
    def setUp(self):
        self.branch = Branch.objects.create(
            ...
            district='Nellore', constituency='Nellore', area='circle', pincode=502286,
    ...
    def test_BranchForm(self):
        form = BranchForm(data={
            ...
            'state': 'AP', 'district': 'Nellore', 'constituency': 'Nellore',
    ...
    def test_BranchForm_invalid(self):
        form = BranchForm(data={
            ...
            'district': '', 'constituency': '', 'area': '', 'phone_number': '',
            'pincode': ''})
    ...
    def test_UserForm_invalid(self):
        form = UserForm(data={
            ...
            'constituency': '', 'area': '', 'mobile': '', 'pincode': ''})
        self.assertFalse(form.is_valid())
    ...
    def test_ClientForm(self):
        form = ClientForm(data={
            ...
            "district": 'Nellore', "constituency": 'Nellore', "area": 'rfc',
