...
class UpdateClientProfileForm(forms.Form):
    ...
    def __init__(self, **kwargs):
        super(UpdateClientProfileForm, self).__init__( **kwargs)
...
class BranchForm(forms.ModelForm):
    ...
    class Meta:
        model = Branch
        fields = ["name", "opening_date", "country", "county",
                  "constituency", "area", "phone_number", "pincode"]
...
class UserForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ["email", "first_name", 'last_name', "gender", "branch",
                  "user_roles", "username", 'country',
                  'county', 'constituency', 'area', 'mobile', 'pincode']
    ...
    def __init__(self, *args, **kwargs):
        ...
        not_required_fields = ['country', 'county',
                               'constituency', 'area', 'mobile',
                               'pincode', 'last_name']
...
class ClientForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ["first_name", "last_name", "date_of_birth", "joined_date",
                  ...
                  "annual_income", "country", "county", "constituency",
